...
const Exercise = () => {
  ...
  return (
    <div>
      <img src="https://julmsejung.com/web-banner/images/horizontal.png" alt="" className="add1"/>
      <div className="abcd">
    ...
    <img src="https://st2.depositphotos.com/5544578/8976/v/950/depositphotos_89763874-stock-illustration-click-here-vertical-advertising-banner.jpg" alt="" className="add2" />
    </div>
